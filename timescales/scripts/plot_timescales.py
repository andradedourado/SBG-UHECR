...
def plot_timescales():
    ...
    plt.plot(np.log10(data_spal_1H[:,0] * 1.e18), data_spal_1H[:,1], label = f'Spallation {PARTICLES_LEGEND[0]}')
    plt.plot(np.log10(data_spal_56Fe[:,0] * 1.e18), data_spal_56Fe[:,1], label = f'Spallation {PARTICLES_LEGEND[4]}')
    plt.yscale('log')
    plt.ylim([1.e2, 1.e7])
