...
def plot_spectrum_earth(l):
    ...
    if l == 'gmm':
        ...
        plt.plot(data_KAB06_gmm[1:,0], compute_spectrum_earth(data_KAB06_gmm[1:,1]) * data_KAB06_gmm[1:,0]**2, label=r'$\gamma \: (pp)$')
    ...
    if l == 'nu':
        ...
        plt.plot(data_KAB06_nu_mu[1:,0], compute_spectrum_earth(data_KAB06_nu_mu[1:,1]) * data_KAB06_nu_mu[1:,0]**2, label=r'$\nu_\mu \: (pp)$')
        plt.plot(data_KAB06_nu_e[1:,0], compute_spectrum_earth(data_KAB06_nu_e[1:,1]) * data_KAB06_nu_e[1:,0]**2, label=r'$\nu_e \: (pp)$')
